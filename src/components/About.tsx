...
import {
  User, Target, Rocket, GraduationCap, Award, Download
} from "lucide-react";
...
const About: React.FC<AboutProps> = ({ colors, darkMode }) => {
  const handleDownloadResume = () => {
    ...
    link.download = 'Diya_Kanwar_Resume.pdf';
          ...
          <div className="flex flex-col gap-6 sm:gap-8">
            ...
            >
              <CardContent className="p-0 h-full flex flex-col justify-center">
                ...
                <Button
                  ...
                  className="w-full px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg group flex items-center justify-center gap-2 focus:ring-4 focus:ring-offset-2"
                  style={{
                    backgroundColor: colors.primary,
                    color: colors.bg,
                    '--tw-ring-color': colors.primary
            ...
            {[
              ...
              <Card
                ...
                style={{
                  backgroundColor:
                    idx % 2 === 0 ? `${colors.secondary}10` : `${colors.primary}10`,
                  borderColor:
                    idx % 2 === 0 ? `${colors.secondary}30` : `${colors.primary}30`,
                  '--tw-ring-color': idx % 2 === 0 ? colors.secondary : colors.primary
                } as React.CSSProperties}
                tabIndex={0}
                role="article"
                ...
                <CardContent className="p-0 h-full flex flex-col justify-center">
                  <div className="flex items-start gap-4 sm:gap-5">
                    <div
                      className="w-14 h-14 sm:w-16 sm:h-16 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-md"
                      style={{
                        backgroundColor: idx % 2 === 0 ? colors.secondary : colors.primary,
                      }}
                      aria-hidden="true"
                    >
                      <item.icon
                  ...
                  {[
                    {
                      ...
                      subtitle: "Chandigarh University ( July 2026)",
                      extra: "CGPA: 7.58",
                      current: true,
                    },
                    {
